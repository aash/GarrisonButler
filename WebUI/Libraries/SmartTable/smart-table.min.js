...
!function (t, e) {
    ...
    t.module("smart-table", []).run(["$templateCache", function (t) {
        ...
        r.stSafeSrc && (l = s(r.stSafeSrc), a.$watch(function () {
            ...
            return h.sort.predicate = e, h.sort.reverse = a === !0, t.isFunction(e) ? h.sort.functionName = e.name : delete h.sort.functionName, h.pagination.start = 0, this.pipe()
            ...
            h.sort.predicate && (s = g(s, h.sort.predicate, h.sort.reverse)), t.number !== e && (t.numberOfPages = s.length > 0 ? Math.ceil(s.length / t.number) : 1, t.start = t.start >= s.length ? (t.numberOfPages - 1) * t.number : t.start, s = s.slice(t.start, t.start + parseInt(t.number))), f(a, s)
        }, this.select = function (t, a) {
            var s = m, n = s.indexOf(t);
            -1 !== n && ("single" === a ? (t.isSelected = t.isSelected !== !0, o && (o.isSelected = !1), o = t.isSelected === !0 ? t : e) : s[n].isSelected = !s[n].isSelected)
        ...
        return {
            restrict: "A", require: "^stTable", link: function (s, n, r, i) {
                ...
                r.stSortDefault && (l = s.$eval(r.stSortDefault) !== e ? s.$eval(r.stSortDefault) : r.stSortDefault), n.bind("click", function () {
                    ...
                    t.predicate !== o ? (p = 0, n.removeClass(f).removeClass(g)) : (p = t.reverse === !0 ? 2 : 1, n.removeClass(d[p % 2]).addClass(d[p - 1]))
                }, !0)
            }
        }
