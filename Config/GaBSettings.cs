...
namespace GarrisonBuddy.Config
{
    public class GaBSettings: Settings
    {
        ...
        [Setting, Styx.Helpers.DefaultValue(true),
        Description("To let the bot start missions select true. To not do missions, select false."), Category("Mission")]
        ...
        [Setting, Styx.Helpers.DefaultValue(true),
        Description("To let the bot pick up the completed work orders from the garden if available select true."), Category("Buildings")]
        ...
        [Setting, Styx.Helpers.DefaultValue(true),
        Description("To let the bot pick up the completed work orders from the mine if available select true."), Category("Buildings")]
